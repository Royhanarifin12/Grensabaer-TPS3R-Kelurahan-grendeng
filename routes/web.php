...
Route::middleware(['auth'])->group(function () {
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/daftar-pengaduan', [DaftarPengaduan::class, 'index'])->name('daftar-pengaduan');
        ...
        Route::delete('/daftar-pengaduan/bulk-destroy', [DaftarPengaduan::class, 'bulkDestroy'])
            ->name('daftar-pengaduan.bulkDestroy');
        ...
        Route::delete('/daftar-testimoni/bulk-destroy', [DaftarTestimoniController::class, 'bulkDestroy'])
            ->name('daftar-testimoni.bulkDestroy');
...
// Paksa reload cache controller - 123