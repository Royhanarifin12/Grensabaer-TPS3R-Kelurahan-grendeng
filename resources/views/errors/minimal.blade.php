...
<head>
    ...
    <link rel="stylesheet" crossorigin href="{{ asset('admin/compiled/css/error.css') }}">
</head>
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    <img class="img-error" src="{{ asset('admin/compiled/svg/error-403.svg') }}" alt="Forbidden">
                    <h1 class="error-title">@yield('content')</h1>
                    <p class="fs-5 text-gray-600">@yield('message')</p>
                    <a href="{{ route('admin.dashboard') }}" class="btn btn-lg btn-outline-primary mt-3">Kembali</a>
                </div>
            </div>
        </div>
